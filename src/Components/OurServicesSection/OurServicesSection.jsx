      ...
      <Container>
        <div className={styles.services_section_container}>
          <div className={styles.services_section_container_item}>
            ...
            <Link style={linkStyle} to={"/weddings"}>
              View
            </Link>
          </div>
          <div className={styles.services_section_container_item}>
            ...
            <Link style={linkStyle} to={"/birthdays"}>
              View
            </Link>
          </div>
          <div className={styles.services_section_container_item}>
            ...
            <Link style={linkStyle} to={"/kidevents"}>
              View
            </Link>
          </div>
          <div className={styles.services_section_container_item}>
            ...
            <Link style={linkStyle} to={"/babyshowers"}>
              View
            </Link>
          </div>
          <div className={styles.services_section_container_item}>
            ...
            <Link style={linkStyle} to={"/sweet16"}>
              View
            </Link>
          </div>
        </div>
